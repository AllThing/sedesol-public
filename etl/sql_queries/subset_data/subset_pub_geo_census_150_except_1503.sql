CREATE TABLE semantic_pub_imputation.pub_geo_census_subset_150_except_1503 AS
    (
    ...
    * lacking SIFODE */
    ...
    pub_to_impute
    WHERE
    pub_locality_id LIKE ANY (array['1500%', '1501%',
                                    '1502%', '1504%', '1505%', '1506%',
                                    '1507%', '1508%', '1509%'])
    ),
    ...
    WHERE locality_id LIKE ANY (array['1500%', '1501%',
                                    '1502%', '1504%', '1505%', '1506%',
                                    '1507%', '1508%', '1509%'])),
    ...
    FROM clean.manzanas
    WHERE manzana_id LIKE ANY (array['1500%', '1501%',
                                    '1502%', '1504%', '1505%', '1506%',
                                    '1507%', '1508%', '1509%']))
