CREATE TABLE semantic_pub_imputation.pub_geo_census_subset_15_except_150 AS
    (
    ...
    * lacking SIFODE */
    ...
    pub_to_impute
    WHERE
    pub_locality_id LIKE ANY (array['151%',
                                    '152%', '153%', '154%', '155%', '156%',
                                    '157%', '158%', '159%'])
    ),
    ...
    WHERE locality_id LIKE ANY (array['151%',
                                    '152%', '153%', '154%', '155%', '156%',
                                    '157%', '158%', '159%'])),
    ...
    FROM clean.manzanas
    WHERE manzana_id LIKE ANY (array['151%',
                                    '152%', '153%', '154%', '155%', '156%',
                                    '157%', '158%', '159%']))
